...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Update</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/{{ $meal->name }}</span>
            </div>
        </div>
        ...
        <form id="formData">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <input type="text" class="form-control" placeholder=" $ " name="price" value="{{ $meal->price }}">
                ...
                <div class="col-4">
                    ...
                    <select class="form-select w-100 p-2 " aria-label="Default select example" name="section_id"
                        ...
                        @foreach ($sections as $section)
                            <option value="{{ $section->id }}"@if ($section->id == $meal->section_id) {{ 'selected' }} @endif>
                                {{ $section->name }}</option>
                        @endforeach
                    </select>
            ...
            <div class="row">
                ...
                <div class="col-12 text-center m-3">
                    ...
                    <textarea name="components" cols="100" rows="3" style="font-size: 20px">{{ $meal->components }}</textarea>
            ...
            <div class="text-center">
                ...
                <button class="btn btn-outline-primary m-5" id="update" product_id="{{ $meal->id }}">
                    Update
                </button>
            </div>
        </form>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.msg == "success") {
                        ...
                        $('#success_alert').text("Success Update : " +
                            data.name);
                    }
