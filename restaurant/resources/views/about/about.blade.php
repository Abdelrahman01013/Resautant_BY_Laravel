    ...
    <div class="container margin: auto">
        <form id="formData">
            ...
            <div class="form-group w-75" style="margin: auto">
                ...
                <input type="text" class="form-control" required id="formGroupExampleInput" placeholder="Example input"
                    name="title_head" value="{{ $about->title_head }}">
            ...
            <div class="w-75 m-5">
                ...
                <textarea name="body_head" id="body_head" rows="5" cols="150" required>{{ $about->body_head }}</textarea>
            ...
            <div class="w-75 m-5">
                ...
                <textarea name="body_footer" id="body_footer" rows="5" cols="150" required>{{ $about->body_footer }}</textarea>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="phone" class="form-control" id="formGroupExampleInput"
                            placeholder="phone" value="{{ $about->phone }}" required>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="email" required class="form-control" id="formGroupExampleInput"
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="opening_hours" required
                            id="formGroupExampleInput" placeholder="OPENING HOURS" value="{{ $about->opening_hours }}">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="workers" required id="workers"
                            placeholder="Workers" value="{{ $about->workers }}">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="facebook" id="formGroupExampleInput"
                            placeholder="facebook" value="{{ $about->facebook }}">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="insta" id="formGroupExampleInput"
                            placeholder="instagram" value="{{ $about->insta }}">
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="linked_in" id="formGroupExampleInput"
                            placeholder="linked_in" value="{{ $about->linked_in }}">
                    </div>
                </div>
            ...
            <div class="text-center m-5">
                ...
                <button class="btn btn-outline-primary m-5" id="submit" product_id="{{ $about->id }}"> Update
                </button>
    ...
    <script>
        ...
        $(document).on('click', '#submit', function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('about.update', '') }}" + "/" + product_id,
                data: formData,
                processData: false,
                contentType: false,
                cache: false,
